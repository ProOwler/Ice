...
class Apc
{
     ...
     */
    function cacheInfo($type = '', $limited = false)
    {
     ...
     */
    function smaInfo($limited = false)
    {
     ...
     * @return bool Returns TRUE on success or FALSE on failure.
     */
    function defineConstants($key, array $constants, $case_sensitive = true)
    {
     ...
     * @return bool Returns TRUE on success or FALSE on failure.
     */
    function compileFile($filename, $atomic = true)
    {
     ...
     * @return bool Returns TRUE on success or FALSE on failure.
     */
    function loadConstants($key, $case_sensitive = true)
    {
     ...
     */
    function inc($key, $step = 1, &$success = null)
    {
     ...
     * @return int|bool Returns the current value of key's value on success, or FALSE on failure.
     */
    function dec($key, $step = 1, &$success = null)
    {
     ...
     */
    function binDumpfile($files, $user_vars, $filename, $flags = 0, $context = null)
    {
     ...
     */
    function binLoadfile($filename, $context = null, $flags = 0)
    {
